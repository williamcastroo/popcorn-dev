...
<div class="tv-poster">
    ...
    <div class="tv-meta-data">
        ...
        <div data-toggle="tooltip" data-placement="right" title="<%= Math.round(rating.percentage) / 10 %> /10"
             class="star-container-tv">
            ...
            <div class="tabs-episodes">
                ...
                <div class="tab-episodes season-<%=season %>">
                    <ul>
                        ...
                        next = value[nextepisode].tvdb_id;
                        }
                        }catch(err){console.log(err);}
                        %>
                        <li class="tab-episode" data-id="<%=episodeData.tvdb_id %>" data-next="<%=next%>">
                            ...
                            <span id="watched-<%=episodeData.season%>-<%=episodeData.episode%>" class="watched"><img
                                        src="images/icons/Player/ViewMoreInfo.png"/></span>
